...
python train_ODE_quanonet.py --operator Homogeneous --config configs/config_ODE.json
python train_ODE_quanonet.py --operator Custom --custom_ode "u + 2*u0" --custom_name "MyOperator"
...
class ODEOperatorSolver:
    """ODE operator problem solver for QuanONet"""
    ...
    def run_complete_pipeline(self):
        ...
        print(f"=== QuanONet {self.operator_type} Operator Solving Pipeline ===")
        print(f"Operator Description: {self.get_operator_description()}")
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='QuanONet ODE Operator Solving')
    ...
    print("=== ODE Operator QuanONet Training System ===")
