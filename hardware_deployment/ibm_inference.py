...
def main():
    ...
    parser.add_argument('--weight_path', type=str, default="Antideriv/Antideriv_QuanONet_Net5-1-5-1_Q2_TF_S0.001_1000x100_Seed0/best_model.npz", help="Path to the pre-trained weights.")
