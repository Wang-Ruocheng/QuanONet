...
| `reproduce_benchmarks2.sh`  | **Aligned Parameter Comparison**: Compares TF-QuanONet against FNO and DeepONet at matched parameter counts. FNO comparison is exclusive to this experiment. |
