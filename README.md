...
This is an operator learning project, supporting the solution of ODE and 2-dim PDE operator problems.
...
├── environment.yml&requirements.txt # Environment and package requirements
└──...
```
...
- `net_size`: Network structure [branch_depth, branch_linear_depth, trunk_depth, trunk_linear_depth] for QuanONet, [depth, linear_depth] for HEAQNN, \[hidden_layer_depth, hidden_layer_wide] for FNN, [branch_depth, branch_width, trunk_depth,trunk_width] for DeepONet]
...
To visualize the different operator, please change the operator_type variable in the first cell.