...
from core.quantum_circuits import generate_simple_hamiltonian, ham_diag_to_operator, generate_diag_from_rank, generate_ham_diag, generate_ham_diag_rank1
...
class ODEOperatorSolver:
    ...
    def create_model(self):
        ...
        # Create Hamiltonian
        diag = generate_ham_diag_rank1(self.config['num_qubits'], self.config['random_seed'])
